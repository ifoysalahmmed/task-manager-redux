    ...
    <div className="h-screen sticky top-0 border-r-2 border-secondary/20">
      <div className="flex flex-col items-center gap-5 h-full py-5">
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "p-2 mt-auto rounded-2xl bg-primary text-white cursor-pointer"
              : "p-2 mt-auto rounded-2xl group hover:bg-primary text-secondary/40 cursor-pointer transition-all"
          }
        >
